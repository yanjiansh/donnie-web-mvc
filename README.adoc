...
can also use Gradle. It also shows values of `com.example` and `donnie-web-mvc` as
...
"`welcome page,`"donnie-web-mvct/ which means it is served up as the root resource (that is, at
